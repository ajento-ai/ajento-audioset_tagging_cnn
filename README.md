...
## Web service / GCP deployment
A ready-to-deploy upload-and-tag web service (FastAPI + Docker + Cloud Run) lives in [app/](app/) and [deploy/](deploy/). See [DEPLOY.md](DEPLOY.md) for one-command deployment to Cloud Run and mapping it to a domain such as `audiotagging.ajento.app`.
